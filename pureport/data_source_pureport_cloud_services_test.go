		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestMatchResourceAttr(resourceName, "services.#", regexp.MustCompile("[0-9]{1,2}")),
					...
					resource.TestCheckResourceAttr(resourceName, "services.13.id", "aws-s3-us-east-1"),
					resource.TestCheckResourceAttr(resourceName, "services.13.href", "/cloudServices/aws-s3-us-east-1"),
					resource.TestCheckResourceAttr(resourceName, "services.13.name", "AWS S3 us-east-1"),
					resource.TestCheckResourceAttr(resourceName, "services.13.provider", "AWS"),
					resource.TestCheckResourceAttr(resourceName, "services.13.service", "S3"),
					resource.TestMatchResourceAttr(resourceName, "services.13.ipv4_prefix_count", regexp.MustCompile("[0-9]{1,2}")),
					resource.TestMatchResourceAttr(resourceName, "services.13.ipv6_prefix_count", regexp.MustCompile("[0-9]{1,2}")),
					resource.TestCheckResourceAttr(resourceName, "services.13.cloud_region_id", "aws-us-east-1"),
				),
			},
		},
	})
