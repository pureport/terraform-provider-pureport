...
func dataSourceOracleConnection() *schema.Resource {
	...
	return &schema.Resource{
		Read:   dataSourceOracleConnectionRead,
		Schema: connection_schema,
	}
}

func dataSourceOracleConnectionRead(d *schema.ResourceData, m interface{}) error {
